...
SELECT * from arte_danzario.inscribe
UNION ALL
SELECT * from artes_escenicas.inscribe
UNION ALL
SELECT * from artes_musicales.inscribe
UNION ALL
SELECT * from artes_plasticas_y_visuales.inscribe

CREATE VIEW estudiantes_artes AS
SELECT * from arte_danzario.estudiantes
UNION ALL
SELECT * from artes_escenicas.estudiantes
UNION ALL
SELECT * from artes_musicales.estudiantes
UNION ALL
SELECT * from artes_plasticas_y_visuales.estudiantes

---------------------------------------------------------------------------------------------------------------
-- FUNCIONES PREDEFINIDAS: SE CREA LA FUNCION SEND_TO_PRESTAMOS DEBIDO A QUE LA TABLA PRESTA SE ENCUENTRA
-- EN LA FACULTAD DE INGENIERIA, ADEMÁS SE CREA LA FUNCIÓN PARA VALIDAR EL ISBN DE UN LIBRO
---------------------------------------------------------------------------------------------------------------
...
---------------------------------------------------------------------------------------------------------------
CREATE ROLE ingresar_artes LOGIN PASSWORD 'ingresar_artes'

GRANT SELECT ON TABLE estudiantes_artes TO ingresar_artes
...
NATURAL JOIN estudiantes_artes
WHERE cod_e = current_user::bigint;

GRANT SELECT ON notas TO estudiante;

SELECT send_to_presta(20191001101, 100100100, 1, '2001-11-01', '2002-01-01');
...
GRANT USAGE ON SCHEMA artes_plasticas_y_visuales TO profesor; ----FALTA --------------------------------------
GRANT SELECT, UPDATE ON ver_notas_estudiante_profesor TO profesor;
GRANT UPDATE ON artes_plasticas_y_visuales.inscribe TO profesor;
...
BEGIN
    ...
    UPDATE artes_escenicas.inscribe
    SET n1 = COALESCE(NEW.n1, n1),
        n2 = COALESCE(NEW.n2, n2),
        n3 = COALESCE(NEW.n3, n3)
    WHERE cod_e = NEW.cod_e AND id_p = current_user::integer
    ...
    UPDATE artes_musicales.inscribe
    SET n1 = COALESCE(NEW.n1, n1),
        n2 = COALESCE(NEW.n2, n2),
        n3 = COALESCE(NEW.n3, n3)
    WHERE cod_e = NEW.cod_e AND id_p = current_user::integer
    ...
    UPDATE artes_plasticas_y_visuales.inscribe
    SET n1 = COALESCE(NEW.n1, n1),
        n2 = COALESCE(NEW.n2, n2),
        n3 = COALESCE(NEW.n3, n3)
    WHERE cod_e = NEW.cod_e AND id_p = current_user::integer
...
---------------------------------------------------------------------------------------------------------------
CREATE ROLE coordinador LOGIN PASSWORD 'coordinador';
...
GRANT USAGE ON SCHEMA arte_danzario TO "22003";
GRANT USAGE ON SCHEMA artes_escenicas TO "22006";
GRANT USAGE ON SCHEMA artes_musicales TO "22013";
GRANT USAGE ON SCHEMA artes_plasticas_y_visuales TO "22017";

GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE arte_danzario.estudiantes TO "22003";
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE artes_escenicas.estudiantes TO "22006";
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE artes_musicales.estudiantes TO "22013";
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE artes_plasticas_y_visuales.estudiantes TO "22017";

---------------------------------------------------------------------------------------------------------------
-- CREAMOS LA VISTA PARA QUE INSERTE, ACTUALICE Y ELIMINE LAS NOTAS DE SUS ESTUDIANTES
---------------------------------------------------------------------------------------------------------------

GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE arte_danzario.inscribe TO "22003";
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE artes_escenicas.inscribe TO "22006";
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE artes_musicales.inscribe TO "22013";
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE artes_plasticas_y_visuales.inscribe TO "22017";
...
GRANT USAGE, SELECT ON SEQUENCE log_table_log_id_seq TO "22003";
GRANT USAGE, SELECT ON SEQUENCE log_table_log_id_seq TO "22006";
GRANT USAGE, SELECT ON SEQUENCE log_table_log_id_seq TO "22013";
GRANT USAGE, SELECT ON SEQUENCE log_table_log_id_seq TO "22017";

GRANT INSERT, UPDATE ON TABLE log_table TO "22003";
GRANT INSERT, UPDATE ON TABLE log_table TO "22006";
GRANT INSERT, UPDATE ON TABLE log_table TO "22013";
GRANT INSERT, UPDATE ON TABLE log_table TO "22017";

CREATE TRIGGER log_changes_estudiantes_danzario
AFTER INSERT OR UPDATE ON arte_danzario.estudiantes
FOR EACH ROW EXECUTE FUNCTION log_changes();

CREATE TRIGGER log_changes_estudiantes_escenicas
AFTER INSERT OR UPDATE ON artes_escenicas.estudiantes
FOR EACH ROW EXECUTE FUNCTION log_changes();

CREATE TRIGGER log_changes_estudiantes_musicales
AFTER INSERT OR UPDATE ON artes_musicales.estudiantes
FOR EACH ROW EXECUTE FUNCTION log_changes();

CREATE TRIGGER log_changes_estudiantes_plasticas
AFTER INSERT OR UPDATE ON artes_plasticas_y_visuales.estudiantes
FOR EACH ROW EXECUTE FUNCTION log_changes();

CREATE TRIGGER log_changes_inscribe_danzario
AFTER INSERT OR UPDATE ON arte_danzario.inscribe
FOR EACH ROW EXECUTE FUNCTION log_changes();

CREATE TRIGGER log_changes_inscribe_escenicas
AFTER INSERT OR UPDATE ON artes_escenicas.inscribe
FOR EACH ROW EXECUTE FUNCTION log_changes();

CREATE TRIGGER log_changes_inscribe_musicales
AFTER INSERT OR UPDATE ON artes_musicales.inscribe
FOR EACH ROW EXECUTE FUNCTION log_changes();

CREATE TRIGGER log_changes_inscribe_plasticas
AFTER INSERT OR UPDATE ON artes_plasticas_y_visuales.inscribe
FOR EACH ROW EXECUTE FUNCTION log_changes();
